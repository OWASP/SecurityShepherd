...
System.out.println("Cross Site Request Forgery Challenge 1 Accessed");
...
{
	System.out.println("DEBUG(CSRFChallenge1.jsp): tokenCookie Error:" + htmlE.toString());
}
	...
	<script type="text/javascript" src="../js/jquery.js"></script>
		<div id="contentDiv">
			...
			<p> 
				...
				<div id="resultsDiv">
					<%= Getter.getCsrfForum(ApplicationRoot, userClass, Getter.getModuleIdFromHash(ApplicationRoot, "s74a796e84e25b854906d88f622170c1c06817e72b526b3d1e9a6085f429cf52")) %>
				</div>
			</p>
		</div>
		<script>

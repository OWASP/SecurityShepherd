...
<%
	ShepherdLogManager.logEvent(request.getRemoteAddr(), request.getHeader("X-Forwarded-For"), "DEBUG: removeModuleBlock.jsp *************************");
...
{
	ShepherdLogManager.logEvent(request.getRemoteAddr(), request.getHeader("X-Forwarded-For"), "DEBUG(removeModuleBlock.jsp): tokenCookie Error:" + htmlE.toString());
}

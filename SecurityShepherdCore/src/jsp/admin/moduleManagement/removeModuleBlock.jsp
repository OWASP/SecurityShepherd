...
<%
	ShepherdExposedLogManager.logEvent(request.getRemoteAddr(), request.getHeader("X-Forwarded-For"), "DEBUG: removeModuleBlock.jsp *************************");
...
{
	ShepherdExposedLogManager.logEvent(request.getRemoteAddr(), request.getHeader("X-Forwarded-For"), "DEBUG(removeModuleBlock.jsp): tokenCookie Error:" + htmlE.toString());
}
...
%>
	<div id="formDiv" class="post">
		<h1 class="title">Remove Module Block</h1>
		<div class="entry">
			<form id="theForm" action="javascript:;">
				<% if (ModuleBlock.blockerEnabled) {%>
					<p>Do you wish to remove the current module blocker?</p>
					<div id="badData"></div>
					<input type="hidden" id="csrfToken" value="<%= csrfToken %>"/>
					<table align="center">
						<tr><td colspan="2" align="center">
							<input type="submit" id="submitButton" value="Disable Module Blocker"/>
						</td></tr>
					</table>
					<script>					

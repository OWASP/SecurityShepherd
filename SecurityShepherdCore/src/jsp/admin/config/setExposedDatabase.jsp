...
<%
System.out.println("DEBUG: setExoposedDatabase.jsp *************************");
...
{
	System.out.println("DEBUG(setExposedDatabase.jsp): tokenCookie Error:" + htmlE.toString());
}

...
<%
	...
	String levelName = "What is Mobile Untrusted Input?";
	//Alphanumeric Only
	String levelHash = "5e2b61c679d1f290d23308b3b66c3ec00cd069f1483b705d17f2795a4e77dcb6";
	//Translation Stuff
	Locale locale = new Locale(Validate.validateLanguage(request.getSession()));
	ResourceBundle bundle = ResourceBundle.getBundle("i18n.lessons.m_untrusted_input." + levelHash, locale);
	ResourceBundle mobile = ResourceBundle.getBundle("i18n.moduleGenerics.mobileGenericStrings", locale);
	//Used more than once translations
	String translatedLevelName = bundle.getString("title.question.m_untrusted_input");
	...
	<div id="contentDiv">
		<p>
			...
			<p> 
				...
				<br>
				<br/>
				<%= mobile.getString("mobileBlurb.vmLink.1") + " UntrustedInput.apk " + mobile.getString("mobileBlurb.vmLink.2") %>

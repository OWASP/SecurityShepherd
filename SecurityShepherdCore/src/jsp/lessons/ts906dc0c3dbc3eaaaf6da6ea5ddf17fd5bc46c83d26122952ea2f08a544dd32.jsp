...
<%
	ShepherdExposedLogManager.logEvent(request.getRemoteAddr(), request.getHeader("X-Forwarded-For"), "Insufficient Transport Layer Protection Lesson Accessed");
...
{
	ShepherdExposedLogManager.logEvent(request.getRemoteAddr(), request.getHeader("X-Forwarded-For"), "DEBUG(Insufficient Transport Layer Protection.jsp): tokenCookie Error:" + htmlE.toString());
}
...
ShepherdExposedLogManager.logEvent(request.getRemoteAddr(), request.getHeader("X-Forwarded-For"), "Broadcast Triggered by: " + userName);

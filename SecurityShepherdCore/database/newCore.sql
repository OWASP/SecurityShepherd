...
CALL cheatsheetCreate('e635fce334aa61fdaa459c21c286d6332eddcdd3', "The The login is vulnerable to SQL injection however the username name field has stronger filtering wheras the password field is weaker.");
CALL cheatsheetCreate('ef6496892b8e48ac2f349cdd7c8ecb889fc982af ', "The chat has not been encrypted but encoded using hex, this can be decoded using burp or the following site: ");

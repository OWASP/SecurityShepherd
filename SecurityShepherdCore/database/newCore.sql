...
INSERT INTO `core`.`modules` (`moduleId`, `moduleName`, `moduleType`, `moduleCategory`, `moduleResult`, `moduleHash`, `moduleStatus`, `incrementalRank`, `scoreValue`, `scoreBonus`, `hardcodedKey`) VALUES ('453d22238401e0bf6f1ff5d45996407e98e45b07', 'Cross Site Request Forgery', 'lesson', 'CSRF', '666980771c29857b8a84c686751ce7edaae3d6ac0b00a55895926c748453ef71', 'ed4182af119d97728b2afca6da7cdbe270a9e9dd714065f0f775cd40dc296bc7', 'open', '43', '40', '5', 0);
...
INSERT INTO modules (moduleId, moduleName, moduleType, moduleCategory, moduleResult, moduleHash, moduleStatus, incrementalRank, scoreValue, scoreBonus, hardcodedKey) VALUES ('3f010a976bcbd6a37fba4a10e4a057acc80bdc09', 'Broken Crypto 1', 'challenge', 'Mobile Broken Crypto', 'd1f2df53084b970ab538457f5af34c8b', 'd2f8519f8264f9479f56165465590b499ceca941ab848805c00f5bf0a40c9717', 'open', '200', '50', '5', 1);
...
CALL cheatsheetCreate('53a53a66cb3bf3e4c665c442425ca90e29536edd', "The Admin credentials are stored in plain text in a db file. Go to /data/data/<packagename>/databases and cat the Members.db file. To get to root CLI on the VM press alt F1.");
CALL cheatsheetCreate('307f78f18fd6a87e50ed6705231a9f24cd582574', " The Admin credentials are encoded in a db file. Go to /data/data/<packagename>/databases and cat the Users.db file. ");
CALL cheatsheetCreate('da3de2e556494a9c2fb7308a98454cf55f3a4911', "The Admin credentials are hashed (but not salted) in a db file. Go to /data/data/<packagename>/databases and cat the db file. ");
...
CALL cheatsheetCreate('a3f7ffd0f9c3d15564428d4df0b91bd927e4e5e4', "The login is vulnerable to SQL injection however, some input is being filtered. OR + 1 = 1 will be filtering into spaces of comments. ");
CALL cheatsheetCreate('e635fce334aa61fdaa459c21c286d6332eddcdd3', "The login is vulnerable to SQL injection however, some input is being filtered. OR + 1 = 1 will be filtering into spaces of comments.");
CALL cheatsheetCreate('ef6496892b8e48ac2f349cdd7c8ecb889fc982af ', "The chat has not been encrypted, encoded using ASCII85");
...
CALL cheatsheetCreate('63bc4811a2e72a7c833962e5d47a41251cd90de3', "The chat has been encrypted using AES (with CBC mode). Multiple keys are used this time but keys are stored insecurely on the App.");
CALL cheatsheetCreate('2ab09c0c18470ae5f87d219d019a1f603e66f944', "The key is stored in the source code of the App, follow the instructions on the lesson to complete.");
CALL cheatsheetCreate('f16bf2ab1c1bf400d36330f91e9ac6045edcd003', "The key is present within a conditional statement in one of the class files.");
...
CALL cheatsheetCreate('1506f22cd73d14d8a73e0ee32006f35d4f234799', "Logs are stored insecurely on the App. These contain the key.");
CALL cheatsheetCreate('831cea34ab83d523cf04cf2d3fc1b908361fa42f', "Logs, however this time the user has revealed the answers to their secret questions in order to reset the password. Investigate the logs, get the secret questions and reset the password to login. The answers are \"Chicken\" and \"Meade\".");

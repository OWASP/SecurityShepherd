...
public class MainActivity extends Activity {
  ...
  public void loginClicked(View v) {
    ...
    if ((etUsername.getText().toString().equals(username) == true)
      ...
      Toast loggedIn = Toast.makeText(MainActivity.this, "Logged in!", Toast.LENGTH_LONG);
      loggedIn.show();
      ...
      Toast error = Toast.makeText(MainActivity.this, "Invalid Credentials!", Toast.LENGTH_LONG);
      error.show();
    }
  }

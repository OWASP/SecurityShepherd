 ...
 *
 */
public class CsrfChallengeApplicationJson extends HttpServlet
{
    private static final long serialVersionUID = 1L;
    private static org.apache.log4j.Logger log = Logger.getLogger(CsrfChallengeJSON.class);
    private static String levelName = "CSRF Challenge Application/JSON";
    private static String levelHash = "0eef5d52fa81412aedda863b6332d6eb39f200aabc650dfe59b5d6981678dcd7";
    /**
            ...
            if(Validate.validateSession(ses))
            {
                ...
                if(Validate.validateTokens(tokenCookie, tokenParmeter))
                {
                    ...
                    if (!contentType.equalsIgnoreCase("application/json")){
                        log.debug("Content type did not match application/json");
                    }
                    log.debug("User submitted content type header: " + contentType);

...
/**
 * Insecure Direct Object Reference Bank Challenge Logout Function DOES NOT RETURN RESULT KEY <br>
 * <br>
...
public class DirectObjectBankLogout extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(DirectObjectBankLogout.class);
  ...
  /**
   * This Servlet is used by a user to Sign out of a Bank Account Session in the Insecure Direct
   * Bank Challenge
   */

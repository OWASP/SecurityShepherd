 ...
 *
 */
public class CsrfChallengeTargetApplicationJson extends HttpServlet
{
    private static final long serialVersionUID = 1L;
    private static org.apache.log4j.Logger log = Logger.getLogger(CsrfChallengeTargetJSON.class);
    private static String levelName = "CSRF Application/JSON Target";
    /**
     ...
     * userId User identifier to be incremented
     */
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(Validate.validateSession(ses))
            {
                ...
                log.debug("Content type detected: " + contentType);
                if((!userId.equals(plusId)) && (contentType.startsWith("application/json")))
                {
                    log.debug("Content type used successfully: " + contentType);

...
/**
 * This class is just an instance memory structure for module blockers. Including the id of the
 * module block, the message to give users and the current block status. <br>
 * <br>

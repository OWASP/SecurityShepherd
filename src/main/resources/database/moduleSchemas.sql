...
GRANT USAGE ON *.* TO 'userLookUuuup'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'userLookUuuup'@'127.0.0.1';
CREATE USER 'userLookUuuup'@'127.0.0.1' IDENTIFIED BY 'youMomaSoTh1n';
GRANT SELECT ON `SqlChalSix`.`users`  TO 'userLookUuuup'@'127.0.0.1';

GRANT USAGE ON *.* TO 'DnTPubUser'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'DnTPubUser'@'127.0.0.1';
CREATE USER 'DnTPubUser'@'127.0.0.1' IDENTIFIED BY 'ch3fBrownSa4useIsS00000Go0d';
GRANT SELECT ON `SQLiC5Shop`.`items` TO 'DnTPubUser'@'127.0.0.1';
GRANT SELECT ON `SQLiC5Shop`.`coupons` TO 'DnTPubUser'@'127.0.0.1';

GRANT USAGE ON *.* TO 'DnTVipUser'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'DnTVipUser'@'127.0.0.1';
CREATE USER 'DnTVipUser'@'127.0.0.1' IDENTIFIED BY 'ch3fBrownSa4useIsS00000Go0d';
GRANT SELECT ON `SQLiC5Shop`.`items` TO 'DnTVipUser'@'127.0.0.1';
GRANT SELECT ON `SQLiC5Shop`.`vipCoupons` TO 'DnTVipUser'@'127.0.0.1';

GRANT USAGE ON *.* TO 'DnTPurUser'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'DnTPurUser'@'127.0.0.1';
CREATE USER 'DnTPurUser'@'127.0.0.1' IDENTIFIED BY 'ch3fBrownSa4useIsS00000Go0d';
GRANT SELECT ON `SQLiC5Shop`.`items` TO 'DnTPurUser'@'127.0.0.1';
GRANT SELECT ON `SQLiC5Shop`.`coupons` TO 'DnTPurUser'@'127.0.0.1';
GRANT SELECT ON `SQLiC5Shop`.`vipCoupons` TO 'DnTPurUser'@'127.0.0.1';

GRANT USAGE ON *.* TO 'firstBloodyMessL'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'firstBloodyMessL'@'127.0.0.1';
CREATE USER 'firstBloodyMessL'@'127.0.0.1' IDENTIFIED BY 'firstBlooded';
GRANT SELECT ON `SqlInjLesson`.`tb_users` TO 'firstBloodyMessL'@'127.0.0.1';

GRANT USAGE ON *.* TO 'CharlieSeabrook'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'CharlieSeabrook'@'127.0.0.1';
CREATE USER 'CharlieSeabrook'@'127.0.0.1' IDENTIFIED BY 'shallowHal';
GRANT SELECT ON `SqlChalEmail`.`customers` TO 'CharlieSeabrook'@'127.0.0.1';

GRANT USAGE ON *.* TO 'RightGuard3d'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'RightGuard3d'@'127.0.0.1';
CREATE USER 'RightGuard3d'@'127.0.0.1' IDENTIFIED BY 'logic3Speaker';
GRANT SELECT ON `SqlChalOne`.`customers` TO 'RightGuard3d'@'127.0.0.1';

GRANT USAGE ON *.* TO 'HdmiNoSignal'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'HdmiNoSignal'@'127.0.0.1';
CREATE USER 'HdmiNoSignal'@'127.0.0.1' IDENTIFIED BY '1nforma1ion';
GRANT SELECT ON `SqlChalThree`.`customers` TO 'HdmiNoSignal'@'127.0.0.1';

GRANT USAGE ON *.* TO 'randomUserName'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER  'randomUserName'@'127.0.0.1';
CREATE USER 'randomUserName'@'127.0.0.1' IDENTIFIED BY 'c4utionHoT';
GRANT SELECT ON `BrokenAuthAndSessMangChalTwo`.`users` TO 'randomUserName'@'127.0.0.1';
GRANT UPDATE ON `BrokenAuthAndSessMangChalTwo`.`users` TO 'randomUserName'@'127.0.0.1';

GRANT USAGE ON *.* TO 'doveM3nCare'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER  'doveM3nCare'@'127.0.0.1';
CREATE USER 'doveM3nCare'@'127.0.0.1' IDENTIFIED BY 'plusm0r3';
GRANT SELECT ON `BrokenAuthAndSessMangChalThree`.`users` TO 'doveM3nCare'@'127.0.0.1';
GRANT UPDATE ON `BrokenAuthAndSessMangChalThree`.`users` TO 'doveM3nCare'@'127.0.0.1';

GRANT USAGE ON *.* TO 'murr4yFe1ld'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'murr4yFe1ld'@'127.0.0.1';
CREATE USER  'murr4yFe1ld'@'127.0.0.1' IDENTIFIED BY '4gainst3ngl4nd';
GRANT SELECT ON `directObjectRefChalOne`.`users` TO 'murr4yFe1ld'@'127.0.0.1';

GRANT USAGE ON *.* TO 'd3nn1sM4nely'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'd3nn1sM4nely'@'127.0.0.1';
CREATE USER  'd3nn1sM4nely'@'127.0.0.1' IDENTIFIED BY 'Pr0ductM4rket1ngIssu3s';
GRANT SELECT ON `directObjectRefChalTwo`.`users` TO 'd3nn1sM4nely'@'127.0.0.1';

GRANT USAGE ON *.* TO 'secureDood'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'secureDood'@'127.0.0.1';
CREATE USER  'secureDood'@'127.0.0.1' IDENTIFIED BY 'iCantEv3n';
GRANT SELECT ON `SqlChalFourSuperSecure`.`users` TO 'secureDood'@'127.0.0.1';

GRANT USAGE ON *.* TO 'csrfChalEnuer'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'csrfChalEnuer'@'127.0.0.1';
GRANT USAGE ON *.* TO 'csrfChalEnuer'@'172.17.0.1' IDENTIFIED BY 'password';
DROP USER 'csrfChalEnuer'@'172.17.0.1';
CREATE USER  'csrfChalEnuer'@'127.0.0.1' IDENTIFIED BY 'c4n1bUplZ';
GRANT SELECT ON `csrfChallengeEnumTokens`.`csrfTokens` TO 'csrfChalEnuer'@'127.0.0.1';
GRANT INSERT ON `csrfChallengeEnumTokens`.`csrfTokens` TO 'csrfChalEnuer'@'127.0.0.1';
GRANT UPDATE ON `csrfChallengeEnumTokens`.`csrfTokens` TO 'csrfChalEnuer'@'127.0.0.1';
...
GRANT USAGE ON *.* TO 'l3tsg0cra'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER  'l3tsg0cra'@'127.0.0.1';
CREATE USER 'l3tsg0cra'@'127.0.0.1' IDENTIFIED BY '83ururMa';
GRANT SELECT ON `BrokenAuthAndSessMangChalFive`.`users` TO 'l3tsg0cra'@'127.0.0.1';
GRANT UPDATE ON `BrokenAuthAndSessMangChalFive`.`users` TO 'l3tsg0cra'@'127.0.0.1';

GRANT USAGE ON *.* TO 'csrfChalFour'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'csrfChalFour'@'127.0.0.1';
CREATE USER  'csrfChalFour'@'127.0.0.1' IDENTIFIED BY 'R1n13U2pv';
GRANT SELECT ON `csrfChallengeFour`.`csrfTokens` TO 'csrfChalFour'@'127.0.0.1';
GRANT INSERT ON `csrfChallengeFour`.`csrfTokens` TO 'csrfChalFour'@'127.0.0.1';
GRANT UPDATE ON `csrfChallengeFour`.`csrfTokens` TO 'csrfChalFour'@'127.0.0.1';

GRANT USAGE ON *.* TO 'randomMoFoName'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER  'randomMoFoName'@'127.0.0.1';
CREATE USER 'randomMoFoName'@'127.0.0.1' IDENTIFIED BY 'c2zXlq_ZoT';
GRANT SELECT ON `BrokenAuthAndSessMangChalSix`.`users` TO 'randomMoFoName'@'127.0.0.1';

GRANT USAGE ON *.* TO 'randomFlower'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER  'randomFlower'@'127.0.0.1';
CREATE USER 'randomFlower'@'127.0.0.1' IDENTIFIED BY 'c21-le_6oT';
GRANT SELECT ON `BrokenAuthAndSessMangChalSeven`.`users` TO 'randomFlower'@'127.0.0.1';

GRANT USAGE ON *.* TO 'tSwsfUSer'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'tSwsfUSer'@'127.0.0.1';
CREATE USER 'tSwsfUSer'@'127.0.0.1' IDENTIFIED BY '9s31iusd-n';
GRANT SELECT ON `CryptShop`.`items` TO 'tSwsfUSer'@'127.0.0.1';
GRANT SELECT ON `CryptShop`.`coupons` TO 'tSwsfUSer'@'127.0.0.1';

GRANT USAGE ON *.* TO 'yourOrEll'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER  'yourOrEll'@'127.0.0.1';
CREATE USER 'yourOrEll'@'127.0.0.1' IDENTIFIED BY '91dj3:766f';
GRANT SELECT ON `UrlAccessThree`.`users` TO 'yourOrEll'@'127.0.0.1';

GRANT USAGE ON *.* TO 'r1ndomFlower'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER  'r1ndomFlower'@'127.0.0.1';
CREATE USER 'r1ndomFlower'@'127.0.0.1' IDENTIFIED BY 'c41-l2_6oT';
GRANT SELECT ON `sqlInjectSeven`.`users` TO 'r1ndomFlower'@'127.0.0.1';

GRANT USAGE ON *.* TO 'al1th3Tokens'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER  'al1th3Tokens'@'127.0.0.1';
CREATE USER 'al1th3Tokens'@'127.0.0.1' IDENTIFIED BY '87SDO63yUN.';
GRANT SELECT ON `securityMisconfigStealToken`.`tokens` TO 'al1th3Tokens'@'127.0.0.1';
GRANT INSERT ON `securityMisconfigStealToken`.`tokens` TO 'al1th3Tokens'@'127.0.0.1';
GRANT EXECUTE ON PROCEDURE `securityMisconfigStealToken`.`getToken` TO 'al1th3Tokens'@'127.0.0.1';
GRANT EXECUTE ON PROCEDURE `securityMisconfigStealToken`.`validToken`  TO 'al1th3Tokens'@'127.0.0.1';

GRANT USAGE ON *.* TO 'theBankMan'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'theBankMan'@'127.0.0.1';
CREATE USER 'theBankMan'@'127.0.0.1' IDENTIFIED BY 'B4ndkm.M98n';
GRANT SELECT ON `directObjectBank`.`bankAccounts` TO 'theBankMan'@'127.0.0.1';
GRANT INSERT ON `directObjectBank`.`bankAccounts` TO 'theBankMan'@'127.0.0.1';
GRANT UPDATE ON `directObjectBank`.`bankAccounts` TO 'theBankMan'@'127.0.0.1';
GRANT EXECUTE ON PROCEDURE `directObjectBank`.`bankAuth` TO 'theBankMan'@'127.0.0.1';
GRANT EXECUTE ON PROCEDURE `directObjectBank`.`currentFunds` TO 'theBankMan'@'127.0.0.1';
GRANT EXECUTE ON PROCEDURE `directObjectBank`.`transferFunds` TO 'theBankMan'@'127.0.0.1';
GRANT EXECUTE ON PROCEDURE `directObjectBank`.`createAccount` TO 'theBankMan'@'127.0.0.1';

GRANT USAGE ON *.* TO 'procChalUser'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'procChalUser'@'127.0.0.1';
CREATE USER 'procChalUser'@'127.0.0.1' IDENTIFIED BY 'k61dSmsM*8n';
GRANT SELECT ON `SqlChalStoredProc`.`customers` TO 'procChalUser'@'127.0.0.1';
GRANT EXECUTE ON PROCEDURE `SqlChalStoredProc`.`findUser` TO 'procChalUser'@'127.0.0.1';

GRANT USAGE ON *.* TO 'imVideoingThis'@'127.0.0.1' IDENTIFIED BY 'password';
DROP USER 'imVideoingThis'@'127.0.0.1';
CREATE USER 'imVideoingThis'@'127.0.0.1' IDENTIFIED BY 'auoi@7723dj';
GRANT SELECT ON `SqlPoorEscape`.`customers` TO 'imVideoingThis'@'127.0.0.1';

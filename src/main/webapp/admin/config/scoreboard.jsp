    ...
    <div class="entry">
        ...
        <div id="configureScoreboardDiv">
            <a href="javascript:;" style="text-decoration: none;"
               id="publicScoreboard"
               title="Make the scoreboard public to everybody">
                <div
                        class="menuButton">Make Scoreboard Public
                </div>
            </a> <a
                href="javascript:;" style="text-decoration: none;"
                id="enableScoreboard"
                title="Enable scoreboard that lists all users regardless of class">
            <div
                    class="menuButton">Enable Scoreboard
            </div>
        </a> <a href="javascript:;"
                style="text-decoration: none;" id="enableAdminScoreboard"
                title="Disable the scoreboard">
            <div class="menuButton">Enable
                Scoreboard for Admins
            </div>
        </a> <a href="javascript:;"
                style="text-decoration: none;" id="disableScoreboard"
                title="Disable the scoreboard">
            <div class="menuButton">Disable
                Scoreboard
            </div>
        </a> <br/>
            ...
            <a href="javascript:;" style="text-decoration: none;"
               id="classSpecific" title="Enable Class Specific Scoreboard">
                <div
                        class="menuButton">Enable Class Specific Scoreboard
                </div>
            </a> <a
                href="javascript:;" style="text-decoration: none;"
                id="adminClassSpecific"
                title="Enable Class Specific Scoreboard For Admins">
            <div

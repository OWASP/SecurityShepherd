...
<div id="contentDiv">
    ...
    <form id="leForm" action="javascript:;">
        ...
        <small><a id="forgottenPasswordLink" href="#"><%= bundle.getString("challenge.form.forgotPassword") %>
        </a></small>
    </form>
    ...
    <div id="forgottenPassDiv" style="display: none;">
        <form id="leForm2" action="javascript:;">
            <h2 class='title'><%= bundle.getString("question.header") %>
            </h2>
            <p>
                ...
                <table>
                    <tr>
                        ...
                        <p style="display: none;"
                           id="answerLoadingSign"><%= bundle.getString("challenge.form.loading") %>
                        </p>
                        </td>
                    </tr>
                </table>

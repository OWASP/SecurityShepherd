...
<div id="contentDiv">
    ...
    <p>
        ...
        <br/> <br/>
    <h3><%= bundle.getString("challenge.description.h3") %>
    </h3>
    ...
    <form id="leForm" action="javascript:;">
        <table>
            <!-- Header -->
            <tr>
                <th><%= bundle.getString("challenge.form.picture") %>
                </th>
                <th><%= bundle.getString("challenge.form.cost") %>
                </th>
                <th><%= bundle.getString("challenge.form.quantity") %>
                </th>
            </tr>
            <!-- Apple Row -->
            <tr>
                ...
                <td><%= bundle.getString("challenge.form.45") %>
                </td>
            ...
            <tr>
                ...
                <td><%= bundle.getString("challenge.form.15") %>
                </td>
                <td><input type="text" style="width: 50px" value="0"
            ...
            <tr>
                ...
                <td><%= bundle.getString("challenge.form.3000") %>
                </td>
                <td><input type="text" style="width: 50px" value="0"
            ...
            <tr>
                ...
                <td><%= bundle.getString("challenge.form.30") %>
                </td>
                <td><input type="text" style="width: 50px" value="0"

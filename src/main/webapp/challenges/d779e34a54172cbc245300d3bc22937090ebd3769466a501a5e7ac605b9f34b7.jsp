...
<div id="contentDiv">
    ...
    <form id="leForm" action="javascript:;">
        <div id="resultsDiv">
            <table>
                <tr>
                    <td><%= bundle.getString("challenge.form.userName") %>
                    </td>
                    <td><input type="text" id="subName" autocomplete="off"/></td>
                </tr>
                <tr>
                    <td><%= bundle.getString("challenge.form.password") %>
                    </td>
        ...
        <small><a id="forgottenPasswordLink" href="#"><%= bundle.getString("challenge.form.forgotPass") %>
        </a></small>
    </form>
    <p style="display: none;" id="loadingSign"><%= bundle.getString("challenge.form.loading") %>
    </p>
    <br/>
    <div id="forgottenPassDiv" style="display: none;">
        <form id="leForm2" action="javascript:;">
            <h2 class='title'><%= bundle.getString("reset.header") %>
            </h2>
            <p><%= bundle.getString("reset.whatToDo") %>
            </p>
            <table>
                <tr>
                    </td>
                    ...
                    <p style="display: none;" id="resetLoadingSign"><%= bundle.getString("challenge.form.loading") %>
                    </p>
                    </td>
                </tr>
            </table>

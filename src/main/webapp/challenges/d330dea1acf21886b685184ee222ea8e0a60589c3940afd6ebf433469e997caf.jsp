...
<head>
    ...
    <title>Security Shepherd - <%= Encode.forHtml(translatedLevelName) %>
    </title>
...
<div id="contentDiv">
    <h2 class="title"><%= Encode.forHtml(translatedLevelName) %>
    </h2>
    <p>
    ...
    <form id="leForm" action="javascript:;">
        <table>
            <tr>
                <td><%= bundle.getString("challenge.form.instruction") %>
                </td>
            </tr>
            <tr>

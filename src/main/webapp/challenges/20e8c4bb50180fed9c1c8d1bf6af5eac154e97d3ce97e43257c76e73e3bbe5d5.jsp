...
<div id="contentDiv">
    ...
    <p>
        ...
        <br/> <br/>
    <h3 class="title"><%=bundle.getString("poorValidation.shopping")%>
    </h3>
    <p><%=bundle.getString("poorValidation.shopping.whatToDo")%>
    </p>
    <br/> <br/>
    <form id="leForm" action="javascript:;">
        <table>
            <!-- Header -->
            <tr>
                <th><%=bundle.getString("poorValidation.picture")%>
                </th>
                <th><%=bundle.getString("poorValidation.cost")%>
                </th>
                <th><%=bundle.getString("poorValidation.quantity")%>
                </th>
            </tr>
            <!-- Apple Row -->
            <tr>
        ...
        <p><%=bundle.getString("poorValidation.howToShop")%>
        </p>
        <table>
            <tr>
                <td>
                    ...
                    <p style="display: none;" id="loadingSign"><%=bundle.getString("poorValidation.loading")%>
                    </p>
                </td>
            </tr>
        </table>

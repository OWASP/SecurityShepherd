...
<div>
    ...
    <div id="contentDiv">
        ...
        <p>
            ...
            <br/> <br/>
        <h1 class='title'><%=bundle.getString("badCrypto.title")%>
        </h1>
        <table>
            <tr>
            ...
            %>
            <tr>
                <td><%= BrokenCryptoHomeMade.challenges.get(i).get(0) %>
                </td>
                <td><%= BrokenCryptoHomeMade.challenges.get(i).get(1) %>
                </td>
                <% if (!BrokenCryptoHomeMade.challenges.get(i).get(0).equalsIgnoreCase("This Challenge")) { %>
                <td><%= BrokenCryptoHomeMade.generateUserSolution(BrokenCryptoHomeMade.challenges.get(i).get(1), ses.getAttribute("userName").toString()) %>
                </td>
                <% } else { %>
                <td>
    ...
    <p style="display: none;" id="loadingSign"><%=bundle.getString("form.loading")%>
    </p>

...
<%
     ...
     * @author Robert Conan
     */
    String levelName = "CSRF Challenge Application/JSON";
    String levelHash = new String("0eef5d52fa81412aedda863b6332d6eb39f200aabc650dfe59b5d6981678dcd7");

//Translation Stuff
    Locale locale = new Locale(Validate.validateLanguage(request.getSession()));
    ResourceBundle bundle = ResourceBundle.getBundle("i18n.challenges.csrf.csrfStrings", locale);
    String i18nLevelName = bundle.getString("title.csrfApplicationJson");
...
<div id="contentDiv">
    ...
    <p>
        ...
        <br/>
        <br/>
        <a> POST /user/csrfchallengejson/application</a>
        <br/>
            <%= bundle.getString("challenge.application") %> <a>{"userId":"<%= bundle.getString("challenge.userIdExample") %>"}</a>
        <br/>
        <br/>
        ...
        <br/>
        <br/>
            <%= bundle.getString("challenge.application.link") %>
            <%
    ...
    <p>
        ...
        <form id="leForm" action="javascript:;">
            <table>
                <tr><td>
                    <%= bundle.getString("forum.iframe.whatToDoJson") %>
                </td></tr>
                <tr><td>

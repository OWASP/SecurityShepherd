...
<head>
    ...
    <title>Security Shepherd - <%= bundle.getString("title.csrf3") %>
    </title>
...
<div id="contentDiv">
    <h2 class="title"><%= bundle.getString("title.csrf3") %>
    </h2>
    <p>
        ...
        <a>userid=<%= bundle.getString("challenge.userIdExample") %> &
            csrfToken=<%= bundle.getString("challenge.userTokenExample") %>
        </a> <br/>
        <br/>
            <%= bundle.getString("challenge.csrfTokenGenerated") %>&nbsp;<%= bundle.getString("challenge.userIdExample") %>&nbsp;<%= bundle.getString("challenge.whereIdIsUserBeenIncremented.2") %>&nbsp;<%= bundle.getString("challenge.yourIdIs") %>&nbsp;<a><%= userId %>
    </a><%= bundle.getString("challenge.yourIdIs.1") %>
        <br/> <br/>
    ...
    <h2 class='title'><%= bundle.getString("result.challengeCompleted") %>
    </h2>
    <p>
            <%= bundle.getString("result.congratsTheKeyIs") %>
        <b>
            <a><%=Hash.generateUserSolution(Getter.getModuleResult(ApplicationRoot, moduleId), (String) ses.getAttribute("userName")) %>
            </a></b><br/>
        <br/>
            <% } %>
    ...
    <form id="leForm" action="javascript:;">
        <table>
            <tr>
                <td><%= bundle.getString("forum.iframe.whatToDo") %>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    ...
                    <p style="display: none;" id="loadingSign"><%= bundle.getString("forum.loading") %>
                    </p>
                </td>
            </tr>
        </table>

...
<head>
    ...
    <title>Security Shepherd - <%= levelName %>
    </title>
...
<div id="contentDiv">
    <h2 class="title"><%= levelName %>
    </h2>
    <p>
            <%= bundle.getString("challenge.whatToDo") %>
        <br/> <br/>
    <h1 class='title'><%= bundle.getString("insecureBank.title") %>
    </h1>
    <p><%= bundle.getString("insecureBank.message") %>
    </p>
    <div id="unauthDiv" <% if (bankSessionDetected) { %>
         style="display: none;" <% } %>>
        <h2 class="title"><%= bundle.getString("insecureBank.signInNow") %>
        </h2>
        <p><%= bundle.getString("insecureBank.signInNow.message") %>
        </p>
        <div id="loginFormDiv">
            <form id="loginForm" action="javascript:;">
                <table>
                    <tr>
                        <td><%= bundle.getString("loginForm.holder") %>
                        </td>
                        <td><input type="text" id="loginAccountHolder"
                                   autocomplete="off"></td>
                    </tr>
                    <tr>
                        <td><%= bundle.getString("loginForm.password") %>
                        </td>
        ...
        <p style="display: none;" id="loginLoadingSign"><%= bundle.getString("form.loading") %>
        </p>
        <div id="loginResultsDiv"></div>
        <br> <br>
        <h2 class="title"><%= bundle.getString("register.makeAccount") %>
        </h2>
        <p><%= bundle.getString("register.makeAccount.message") %>
        </p>
        ...
        <p style="display: none;" id="registrationLoadingSign"><%= bundle.getString("form.loading") %>
        </p>

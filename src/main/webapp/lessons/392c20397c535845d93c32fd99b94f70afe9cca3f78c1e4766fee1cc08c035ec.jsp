...
<div id="contentDiv">
    ...
    <div id="lessonIntro">
        ...
        <%= bundle.getString("paragraph.list.header") %>: </br>
        <ul>
            <li><%= bundle.getString("paragraph.list.1") %>
            </li>
            <li><%= bundle.getString("paragraph.list.2") %>
            </li>
            <li><%= bundle.getString("paragraph.list.3") %>
            </li>
            <li><%= bundle.getString("paragraph.list.4") %>
            </li>
            <li><%= bundle.getString("paragraph.list.5") %>
            </li>
            <li><%= bundle.getString("paragraph.list.6") %>
            </li>
            <li><%= bundle.getString("paragraph.list.7") %>
            </li>
            <li><%= bundle.getString("paragraph.list.8") %>
            </li>
        </ul>

...
<div id="contentDiv">
    ...
    <div id="hint" style="display: none;">
        <h2 class="title"><%= bundle.getString("challenge.hintHeader") %>
        </h2>
    ...
    <form id="leForm" action="javascript:;">
        <table>
            <tr>
                <td><%= bundle.getString("challenge.userName") %>
                </td>
                <td><input type="text" id="userName" autocomplete="off"/></td>
            <tr>
                <td><%= bundle.getString("challenge.password") %>
                </td>
                <td><input type="password" id="userPass" autocomplete="off"/>
                </td>
            <tr>
                <td colspan="2">
                    <div id="submitButton">
                        <input type="submit"
                               value="<%= bundle.getString("challenge.signIn") %> "/>
                    </div>
                    <p style="display: none;" id="loadingSign"><%= bundle.getString("challenge.loading") %>...
                    </p>
                    <div style="display: none;" id="hintButton">
                        <input type="button"
                               value="<%= bundle.getString("button.hint") %>"
                               id="theHintButton"/>
                    </div>
                </td>
            </tr>

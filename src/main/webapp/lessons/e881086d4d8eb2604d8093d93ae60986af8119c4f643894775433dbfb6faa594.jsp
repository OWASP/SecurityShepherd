...
<div id="contentDiv">
    ...
    <div id="hint" style="display: none;">
        ...
        <br/> <br/>
        <div>
            SELECT * FROM tb_users WHERE username ='<a id="userContent"></a>';
        </div>
        <br/> <br/>
    </div>
    ...
    <form id="leForm" action="javascript:;">
        <table>
            <tr>
                <td><%= bundle.getString("enter.user.name") %>
                </td>
            </tr>
            <tr>
                <td><input style="width: 400px;" id="aUserName" type="text"/>
                </td>
            </tr>
            <tr>
                <td>
                    <div id="submitButton">
                        <input type="submit"
                               value="<%= bundle.getString("get.user.button") %>"/>
                    </div>

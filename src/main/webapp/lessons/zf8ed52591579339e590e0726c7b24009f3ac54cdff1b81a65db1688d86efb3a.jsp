...
<div id="contentDiv">
    ...
    <div id="lessonIntro">
        ...
        <%= bundle.getString("example.xss.4") %><br/> <br/> <br/> <input
            type="button" value="<%= bundle.getString("button.hideIntro") %>"
            id="hideLesson"/>
    </div>
    <input type="button"
    ...
    <form id="leForm" action="javascript:;">
        <table>
            <tr>
                <td><%= bundle.getString("paragraph.info.searchTerm") %>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <div id="submitButton">
                        <input type="submit"
                               value="<%= bundle.getString("button.getUser") %>"/>
                    </div>

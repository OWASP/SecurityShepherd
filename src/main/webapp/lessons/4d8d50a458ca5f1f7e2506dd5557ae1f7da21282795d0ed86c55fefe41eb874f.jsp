...
<div id="contentDiv">
    ...
    <form id="leForm" action="javascript:;">
        <table>
            <tr>
                <td><%= bundle.getString("challenge.enterNumber") %>:</td>
                <td><input type="text" id="numberBox" autocomplete="off"/></td>
            <tr>
                <td colspan="2">
                    <div id="submitButton">
                        <input type="submit"
                               value="<%= bundle.getString("button.submitNumber") %>"/>
                    </div>
                    <p style="display: none;" id="loadingSign"><%= bundle.getString("button.loading") %>...
                    </p>

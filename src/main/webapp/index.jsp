        ...
        <div id="theSidebarWrapper" class="sidebarWrapper"
            ...
            <div id="sidebar">
                <ul>
                    ...
                    <li><a id="adminList" href="javascript:;">
                        <div
                                class='menuButton'>
                    ...
                    <div id="levelListDiv">
                        <div id="sideMenuWrapper">
                            ...
                            <li><a id="lessonList" href="javascript:;">
                                <div
                                        class="menuButton">
                            ...
                            <li><a id="challengeList" href="javascript:;">
                                <div
                                        class="menuButton">
                    ...
                    <script>
                        ...
                        setInterval(function () {
                            makeTimer("start", "<% out.print(CountdownHandler.getStartTime()); %>", "CTF will start in ");
                        }, 1000);
                        <%
                        }
                        ...
                        setInterval(function () {
                            makeTimer("lock", "<% out.print(CountdownHandler.getLockTime()); %>", "Points available for ");
                        }, 1000);
                        <%
                        }
                        ...
                        setInterval(function () {
                            makeTimer("end", "<% out.print(CountdownHandler.getEndTime()); %>", "CTF ends in ");
                        }, 1000);
                        <%
                        } %>

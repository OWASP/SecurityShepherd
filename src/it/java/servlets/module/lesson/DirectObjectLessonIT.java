...
public class DirectObjectLessonIT {
  ...
  public String getModuleDoPost(String username, String csrfToken, int expectedResponseCode)
      throws Exception {
    try {
      ...
      if (csrfToken.isEmpty()) {
        ...
        if (servletResponse.contains("You must be getting funky")) {
          ...
          fail(message);
            ...
            "User")) // This string is in all possible responses except unauthenticated
        {

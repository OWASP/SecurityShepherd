...
public class CsrfLessonIT {
  ...
  public String getModuleDoPost(String messageForAdmin, String csrfToken)
  ...
  public void testLevelValidAnswer() throws SQLException, ServletException, IOException {
    ...
    if (csrfToken.isEmpty()) {
      ...
      String messageForAdmin =
          new String(httpsBase + "root/grantComplete/csrflesson?userId=" + falseIdTestValue);
    ...
    try {
      ...
      if (csrfToken.isEmpty()) {
        ...
        String messageForAdmin =
            new String(
                httpsBase
                    + "root/grantComplete/csrflesson?userId="
                    + falseIdTestValue
                    + "wrong"); // +wrong
        // makes the
        // value

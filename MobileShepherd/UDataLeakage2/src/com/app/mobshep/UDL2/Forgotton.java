...
public class Forgotton extends Activity {
	...
	public void cancel(View v) {
		Intent gotoForgot = new Intent("com.app.mobshep.UDL2.UDataLeakage2");
	...
	public void reset(View v) {
		...
		if (CheckQ1.contentEquals("Chicken") || CheckQ2.contentEquals("Meade")) {
			Toast reset = Toast.makeText(Forgotton.this,
					"Password Reset.", Toast.LENGTH_SHORT);
			reset.show();
			
			UDataLeakage2.passwordReset=true;
			
			tempPassVar=getRandomNumber(6);
			
			UDataLeakage2.tempPass=tempPassVar.toString();
			...
			Toast invalid = Toast.makeText(Forgotton.this,
					"Invalid answers.", Toast.LENGTH_SHORT);
			invalid.show();
		}
